    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans flex flex-col overflow-x-hidden">
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-10 max-w-2xl leading-relaxed animate-fadeUp animate-delay-100
          ...
          <span className="font-semibold text-[#213BF6]">gagner du temps</span> et optimiser les processus des entreprises.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fadeUp animate-delay-200">
          <a
            href="#projects"
            className="bg-[#213BF6] text-white dark:bg-[#213BF6] dark:text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:scale-105 hover:shadow-lg transition transform
          ...
          <a
            href="#contact"
            className="border border-[#213BF6] text-[#213BF6] dark:border-[#213BF6] dark:text-[#213BF6] px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-[#213BF6]/10 dark:hover:bg-[#213BF6]/20 hover:scale-105 transition transform
                       text-sm sm:text-base md:text-lg"
          >
            Me contacter
          </a>
